  ...
  const metrics: MetricRow[] = [
    {
      ...
      legacy: '4 to 6 hour batch delays (and 24 to 48 hour Google email digests)',
      kultra: 'Sub-30-second Slack alerts before ad spend burns',
      detail: 'Eliminates blind downtime before Google Smart Bidding shifts ad budget to non-converting variants.',
    },
    {
      title: 'Storefront & Speed Impact',
      legacy: 'Bloated Shopify theme scripts and tracking tags',
      kultra: 'Zero code on client stores and 0% impact on Core Web Vitals',
      detail: 'Operates 100% cloud-side via direct Google API integration with zero store latency and zero theme risk.',
    },
    {
      title: 'Remediation',
      legacy: 'Raw crawler error codes requiring manual catalog hunting',
      kultra: 'Direct Google Merchant Center diagnostic links',
      detail: 'Jump straight to the offending item diagnostics panel to inspect rejected attributes and error reasons in seconds.',
    },
    {
      title: 'Hero SKU Priority',
      legacy: 'Generic alert counters without revenue context',
      kultra: 'Immediate identification of top-selling variants',
      detail: 'Prioritizes high-converting bestsellers before Smart Bidding burns daily budget on zero-traffic variants.',
    },
    {
      title: 'Team Alert Routing',
      legacy: 'Unmonitored shared email inboxes and periodic digests',
      kultra: 'Dedicated Slack channels per client retainer',
      detail: 'Alerts route directly to agency triage channels or client-specific workspaces for instant team triage.',
    },
  ];
      ...
      <div className="relative z-10 max-w-[1140px] mx-auto">
        ...
        <div className="max-w-[760px] mb-12">
          ...
          <h2 className="font-display text-[1.85rem] sm:text-[2.25rem] font-semibold text-[var(--ink-primary)] leading-[1.2]">
            Real-Time Detection vs. Legacy Polling
          </h2>
          <p className="mt-3 text-[14.5px] text-[var(--ink-secondary)] leading-[1.55]">
            Why traditional feed apps and native Google email digests leave client retainers exposed over weekends.
          </p>
        </div>
