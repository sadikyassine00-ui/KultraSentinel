  ...
  return (
    <section className="relative w-full pt-16 md:pt-24 pb-16 px-4 sm:px-6 flex flex-col items-center z-10">
      ...
      <div className="max-w-[1040px] w-full mx-auto text-center flex flex-col items-center">
        {/* Main Heading in Fraunces */}
        <h1 className="font-display text-[2.25rem] sm:text-[3rem] md:text-[3.6rem] font-semibold text-[var(--ink-primary)] leading-[1.15] tracking-[-0.01em] max-w-[960px] mx-auto text-center">
          Stop losing ad spend to silent Google Merchant disapprovals
        </h1>

        {/* Subheadline in Inter */}
        <p className="mt-6 text-[15px] sm:text-[16px] text-[var(--ink-secondary)] leading-[1.6] max-w-[640px] mx-auto text-balance">
        ...
        {/* Action Group: Primary and Secondary buttons (§4) */}
